...
## About :
🔴 'Kerial-Banking' functions as a miniature replica of a bank that performs basic operations like **money transfers**, **loan requests**, **account closures**, and **viewing your balance**. Moreover, all transactions will be listed in the log as either **withdrawals** or **deposits** with there given timestamps.
